    ...
    return (
        <div className="bg-surface-container-low p-8 md:p-12 rounded-[3rem] border-ghost max-w-md w-full text-center shadow-ambient-lg">
            ...
            <div className="space-y-4">
                ...
                >
                    <button type="submit" className="w-full bg-surface-container-lowest border border-outline-variant/30 text-on-surface px-6 py-4 rounded-full font-bold shadow-sm hover:bg-surface-container hover:shadow-md active:scale-95 transition-all flex items-center justify-center gap-3 cursor-pointer">
                ...
                >
                    <button type="submit" className="w-full bg-[#24292e] text-white px-6 py-4 rounded-full font-bold shadow-sm hover:bg-[#2c3238] hover:shadow-md active:scale-95 transition-all flex items-center justify-center gap-3 cursor-pointer">
                        <svg className="w-6 h-6" viewBox="0 0 98 96" fill="white" aria-hidden="true">
